...
float asfloat(int input);
float asfloat(uint input);
...
float16\_t asfloat16(float16\_t input);
float16\_t asfloat16(int16\_t input);
float16\_t asfloat16(uint16\_t input);
...
int16\_t asint16(float16\_t input);
int16\_t asint16(int16\_t input);
int16\_t asint16(uint16\_t input);
...
int asint(float input);
int asint(int input);
int asint(uint input);
...
void asuint(double input, out uint lowBits, out uint highBits);
template<uint N> void asuint(vector<double, N> input, out vector<uint, N> lowBits, out vector<uint, N> highBits);

uint asuint(float input);
uint asuint(int input);
uint asuint(uint input);
...
uint16\_t asuint16(float16\_t input);
uint16\_t asuint16(int16\_t input);
uint16\_t asuint16(uint16\_t input);
...
\begin{itemize}
  ...
  value.
  \item \textit{Remarks:} An implementation will only provide this function if
  it supports native 16-bit data types.
\end{itemize}
...
\begin{itemize}
  \item \textit{Returns:} A scalar or vector object of 16-bit unsigned integer
  values. Each bit in the object representation of the \texttt{input} argument
  is replicated into the newly created unsigned integer scalar or vector return
  value.
  \item \textit{Remarks:} An implementation will only provide this function if
