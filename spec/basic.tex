...
lengths must be between 1 and 4 (i.e. \( 1 \leq N \leq 4 \) ).
...
floating point type, and has a type alias \texttt{float32_t}. The
\texttt{double} type is a 64-bit floating point type, and has a type alias
\texttt{float64_t}. Both the \texttt{float} and \texttt{double} types have
