...
% \Annex{<normative|informative>}{<title>}{<label>}
%
...
\newcommand{\Annex}[3]{%
  ...
  \chaptermark{Annex \thechapter}%
  \vspace{-2\baselineskip}%
  \begin{center}
    {\Large\bfseries Annex \thechapter}\\[0.3em]
    {\normalfont (#1)}\\[1.5em]
    {\Large\bfseries #2\hfill[#3]}
  \end{center}%
  \addcontentsline{toc}{chapter}{Annex \thechapter (#1): #2}%
  \label{#3}%
}
