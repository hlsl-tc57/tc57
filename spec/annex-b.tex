...
site (\url{https://learn.microsoft.com/en-us/windows/win32/direct3d10/d3d10-graphics-reference-effect}).

\p The main additions to HLSL for the Effects feature are the annotation
syntax (\url{https://learn.microsoft.com/en-us/windows/win32/direct3d10/d3d10-effect-annotation-syntax})
...
\p The effects syntax has three keywords: \texttt{sampler\_state},
\texttt{technique10}, and \texttt{pass}.
